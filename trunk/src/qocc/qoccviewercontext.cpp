...
{
	myContext->CloseAllContexts();		//mark 1-29-09 - fix segfault on slotNeutralSelection when File|New had been clicked while a local context was open and something was selected
